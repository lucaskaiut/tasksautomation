...
class UpdateProjectEnvironmentProfileRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        $profile = $this->route('environmentProfile');

        return $project instanceof Project
            && $profile instanceof ProjectEnvironmentProfile
            && $profile->project_id === $project->id
            && (bool) $this->user()?->can('update', $project);
    }
    ...
    public function rules(): array
    {
        /** @var Project $project */
        $project = $this->route('project');
        /** @var ProjectEnvironmentProfile $profile */
        $profile = $this->route('environmentProfile');
        ...
        return [
            ...
            'slug' => [
                ...
                'max:255',
                'alpha_dash',
                Rule::unique('project_environment_profiles', 'slug')
